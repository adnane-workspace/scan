  ...
  return (
    <section className="flex flex-col gap-stack-md rounded-2xl bg-surface-container p-stack-lg shadow-sm">
      <div className="mb-2 flex items-center gap-2">
        ...
        <h2 className="text-headline-md font-semibold text-on-surface">Les Plus Populaires</h2>
      </div>

      {loading ? (
        <p className="text-sm text-on-surface-variant">Chargement...</p>
      ) : popular.length === 0 ? (
        <p className="text-sm text-on-surface-variant">Aucun produit pour le moment.</p>
      ) : (
